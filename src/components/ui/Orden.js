...
const Orden = ({ orden}) => {
    ...
    return ( 
        <div className="sm:w-1/2 lg:w-1/3 px-2 mb-4">
            <div className="pa-3 shadow-md bg-white">
                ...
                {orden.tiempoentrega === 0 &&(
                    <div className="mb-4">
                        ...
                        <input
                            type="number"
                            className="shadow appearance-none borden rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                            min="1"
                            max="20"
                            placeholder="20"
                            value={tiempoentrega}
